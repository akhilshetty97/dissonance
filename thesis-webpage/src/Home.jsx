      ...
      <div className='w-full h-screen flex flex-col justify-center items-center relative'>
        ...
        <div className='absolute inset-0 flex flex-col justify-center items-center'>
          ...
          <div className='flex items-center pt-8 2xl:pt-12'> 
            <div className='flex-col items-center px-12 2xl:px-20' onMouseEnter={() => handleVideoChange('1')} onMouseLeave={() => setShowTextArea(false)}>
            ...
            <Line/>
            <div className='flex-col items-center px-12 2xl:px-20' onMouseEnter={() => handleVideoChange('2')} onMouseLeave={() => setShowTextArea(false)}>
            ...
            <Line/>
            <div className='flex-col items-center px-12 2xl:px-20' onMouseEnter={() => handleVideoChange('3')} onMouseLeave={() => setShowTextArea(false)}>
            ...
            <Line/>
            <div className='flex-col items-center px-12 2xl:px-20' onMouseEnter={() => handleVideoChange('4')} onMouseLeave={() => setShowTextArea(false)}>
