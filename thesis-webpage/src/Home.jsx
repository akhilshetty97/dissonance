...
function App() {
  ...
  return (
      <div className='w-full h-screen'>
        <img className='absolute overlay object-cover' src={texture} />
        <video id='0' className="w-full min-h-screen object-cover transition-opacity duration-500 ease-in-out" src={staticVideo} autoPlay loop muted />
        <video id='1' className="w-full min-h-screen object-cover transition-opacity duration-500 ease-in-out hidden" src={consistency} autoPlay loop muted />
        ...
        <div className='absolute w-full min-h-screen top-0'>
          ...
          <div className='flex justify-around items-center pl-10' style={{paddingTop:'8rem'}}>
